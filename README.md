...
## PROGRAM:
## House Price Model Training.html
```
<!doctype html>
<html lang="en">
  <head>
...
## RESULT:
Thus a website is designed for calculate house price and is hosted in the URL http://tamil.student.saveetha.in:8000/HouseModelTraining/ , http://tamil.student.saveetha.in:8000/HouseModelPrediction/ .